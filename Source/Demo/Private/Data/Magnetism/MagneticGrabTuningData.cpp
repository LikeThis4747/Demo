...
bool UMagneticGrabTuningData::IsConfigured(FString& OutError) const
{
	...
	if (!ValidateFloat(TEXT("GrabRange"), GrabRange, 100.0f, 3000.0f)
		...
		|| !ValidateFloat(TEXT("ExplosionSparkReferenceRadius"), ExplosionSparkReferenceRadius, 1.0f, 2000.0f)
		|| !ValidateFloat(TEXT("ExplosionSparkEmissionSeconds"), ExplosionSparkEmissionSeconds, 0.01f, 1.0f)
		|| !ValidateFloat(TEXT("ExplosionFireSmokeVisualScale"), ExplosionFireSmokeVisualScale, 0.1f, 10.0f)
		|| !ValidateFloat(TEXT("ExplosionFireSmokeEmissionSeconds"), ExplosionFireSmokeEmissionSeconds, 0.01f, 2.0f)
