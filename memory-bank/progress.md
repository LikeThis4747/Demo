...
- [x] 2026-08-06 白天完成 HeavyImpact 正式集成、自动冲锤、相机更新顺序修复、起身动画准备、壁挂式一次性制导机关及低顶 L 形测试区；已有构建、自动化或静态验证证据按各任务边界记录。
- [x] 当前工作区、Git LFS 与 `main...origin/main` 在夜间快照前干净，分叉 0/0。
