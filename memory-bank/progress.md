...
- [x] 玩家/追猎者共享 HeavyImpact 真实 Chaos 受击、倒地起身恢复桥与物理姿势准备增量；Demo 模块构建、双 MCP 资产回读及 5/5 自动化已通过。
- [ ] HeavyImpact 正躺/趴倒、物理收拢到 Montage 的画面连续性、墙边/墙角、完全堵塞/解除、二次接触与恢复移动的用户验收。
...
- HeavyImpact 物理姿势准备增量已完成代码、AnimBP、参数、构建和自动化；真实命中连续画面、墙边和恢复追逐仍待用户验收。
