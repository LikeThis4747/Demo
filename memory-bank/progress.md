...
- [x] 玩家/追猎者共享 HeavyImpact 真实 Chaos 受击、倒地起身恢复桥与物理姿势准备增量；Demo 模块构建、官方 MCP 资产回读及 5/5 自动化已通过。
...
- HeavyImpact 物理姿势准备增量已完成代码、AnimBP、参数、构建和自动化；短 PIE 未产生真实 Chaos 命中，不能替代用户对收拢、闪切、墙边和恢复控制的画面验收。
