...
_EDITOR_ACTIONS = [
    ...
    ActionDef(
        ...
        examples=(
            {
                "old_asset_path": "/Game/MyProject/Blueprints/UI/WBP_Old.WBP_Old",
                "new_package_path": "/Game/MyProject/Blueprints/UI",
                "new_name": "WBP_New",
            },
            {
                "items": [
                    {
                        "old_asset_path": "/Game/MyProject/Blueprints/UI/WBP_A.WBP_A",
                        "new_package_path": "/Game/MyProject/Blueprints/UI",
                        "new_name": "WBP_A1",
                    },
                    {
                        "old_asset_path": "/Game/MyProject/Blueprints/UI/WBP_B.WBP_B",
                        "new_package_path": "/Game/MyProject/Blueprints/UI",
                        "new_name": "WBP_B1",
                    },
                ],
    ...
    ActionDef(
        ...
        input_schema={
            ...
            "properties": {
                "asset_path": {
                    "type": "string",
                    "description": "Optional single full asset path (e.g. /Game/MyProject/Art/T_Icon.T_Icon).",
                },
                "asset_paths": {
                    "type": "array",
                    "items": {"type": "string"},
        ...
        examples=(
            {},
            {"size": 256},
            {"asset_paths": ["/Game/MyProject/Art/T_IconA.T_IconA", "/Game/MyProject/Art/T_IconB.T_IconB"]},
            {"asset_ids": ["/Game/MyProject/Art/T_Icon.T_Icon"], "size": 256},
        ),
    ),
    ActionDef(
    ...
    ActionDef(
        ...
        input_schema={
            ...
            "properties": {
                "asset_path": {
                    "type": "string",
                    "description": "Full asset path (e.g. /Game/MyProject/Blueprints/BP_Foo)",
                },
                "revision": {
                    "type": "integer",
        ...
        risk="safe",
        examples=(
            {"asset_path": "/Game/MyProject/Blueprints/Character/Player/BP_SideScrollingCharacter"},
            {"asset_path": "/Game/MyProject/Blueprints/BP_SideScrollingGameMode", "revision": 42},
        ),
    ),
    ActionDef(
        ...
        examples=(
            {"asset_path": "/Game/MyProject/Blueprints/Character/Player/BP_SideScrollingCharacter"},
            {"asset_path": "/Game/MyProject/Blueprints/BP_Foo", "max_count": 10},
        ),
    ),
    ActionDef(
        id="editor.get_logs",
