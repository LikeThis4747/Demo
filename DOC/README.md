...
- `DailyPlan/2026-08-10-统一轻受击响应第一版实施计划.md`：玩家与追猎者共享站立轻受击接收、优先级和 Heavy 抢占规则；首轮用磁力真实碰撞与地刺分别验证 AI Stop、玩家 Stop/AI Slow、空中保留垂直速度及与既有 Heavy 的互斥。用户已授权实现，当前先完成代码落盘前基线门禁。
