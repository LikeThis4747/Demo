...
- `DailyPlan/2026-08-12-PCG机关与资源分层放置.md`：机关优先、资源后置的一体化 Population 方案；高厅必放摆锤，普通机关和资源分别做整栋通行图最小间距采样，当前已完成技术接入并等待体验校准。
- `DailyReport/2026-08-12-PCG机关与资源分层放置技术交付.md`：记录旧规则替换、类型先抽、实际操作格互斥、资源格内随机、三档首验值，以及构建、29 项 PCG 自动化和 `L_Game` 代表 Seed 接入证据。
