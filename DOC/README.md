...
- `DailyPlan/2026-08-06-壁挂式物理制导一次性机关实施计划.md`：正面墙/拐角墙一次性物理制导机关的当前实施方案；已完成固定主推力、惯量感知转矩、出生净空和首碰停推重构，等待用户 PIE 手感验收。
- `DailyReport/2026-08-10-壁挂式物理制导机关稳定性重构实施记录.md`：记录本轮六文件稳定性重构、默认参数、官方 MCP 资产回读、Demo-only 完整构建与未覆盖的运行验收边界。
